            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('shift.store', [$shift->id])}}" method="POST">
                            @csrf

                            <div class="card-body">
                                <div class="form-group">
                                    <label for="">Nama Shift</label>
                                    <input type="text" class="form-control" name="nama_shift" value="{{old('nama_shift') ? old('nama_shift') : $shift->nama_shift}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                                        <input type="text" name="jam_masuk" class="form-control datetimepicker-input"
                                            data-target="#datetimepicker1" value="{{old('jam_masuk') ? old('jam_masuk') : $shift->jam_masuk}}" placeholder="Format waktu 24jam"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                                        <input type="text" name="jam_keluar" class="form-control datetimepicker-input"
                                            data-target="#datetimepicker2" value="{{old('jam_keluar') ? old('jam_keluar') : $shift->jam_keluar }}" placeholder="Format waktu 24jam"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
                                        <input type="text" name="toleransi_telat" class="form-control datetimepicker-input"
                                            data-target="#datetimepicker3" value="{{old('toleransi_telat') ? old('toleransi_telat') : $shift->toleransi_telat}}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" id="" class="form-control" placeholder="Masukkan keterangan">{{old('keterangan') ? old('keterangan') : $shift->keterangan}}</textarea>
                                </div>
                            </div>
                            <!-- /.card-body -->
